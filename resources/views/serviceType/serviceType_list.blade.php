...
<section class="section">
    <div class="section-header">
        <h1>List Jenis Pelayanan</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="/jenisruanganList">{{ $title }}</a></div>
            <div class="breadcrumb-item">List Jenis Pelayanan</div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                                ...
                                @foreach ($serviceTypes as $serviceType )
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href=# class="btn btn-danger jenis-delete" data-id="{{ $serviceType->id }}"><i class="fas fa-trash"></i></a>
                                        @endcan  
                                        </td>
                                  </tr>
                                  @endforeach
                    ...
                    <div class="d-flex justify-content-center">{{ $serviceTypes->links() }}</div>
                </div>
            </div>
        </div>
    </div>
