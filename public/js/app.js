...
(0,firebase_messaging__WEBPACK_IMPORTED_MODULE_2__.getToken)(messaging, {
  vapidKey: 'BI3BBdN--LQVb8hs6BRokBx6XLmA-aUzpF-nuCmxMQKm16gaiOWlKPYJ9Sce9tzoOB_XbdGnUqSMYx4DbT9oDCM'
...
function requestPermissions() {
  Notification.requestPermission().then(function (permission) {
    if (permission === 'granted') {
      console.log('Notification permission granted.'); // TODO(developer): Retrieve a registration token for use with FCM.
      // ...
    } else {
